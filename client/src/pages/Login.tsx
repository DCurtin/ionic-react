    ...
    <IonPage>
      ...
      <IonContent>
            <IonList>
              ...
              <IonItem><IonInput type="password" value={password} placeholder="Enter Input" onKeyUp={function(e){console.log(e); console.log(e.type);}} onIonChange={e => setPassword(e.detail.value!)} clearInput></IonInput></IonItem>

    ...
    <IonPage>
      ...
      <IonContent>
            <IonList>
              ...
              <IonItem><IonInput type="password" value={password} placeholder="Enter Input" onIonChange={e => e.type === 'submit' ? login(username, password, history) : setPassword(e.detail.value!)} clearInput></IonInput></IonItem>

    ...
    <IonPage>
      ...
      <IonContent>
            <IonList>
              ...
              <IonItem><IonInput type="password" value={password} placeholder="Enter Input" onIonChange={function(e){console.log(e); return e.type === 'submit' ? login(username, password, history) : setPassword(e.detail.value!)}} clearInput></IonInput></IonItem>
